...
CREATE TABLE IF NOT EXISTS company_settings (
  ...
  invoice_title_visible INTEGER DEFAULT 1,
  invoice_title_align TEXT DEFAULT 'center',
  invoice_title_bold INTEGER DEFAULT 1,
  invoice_subtitle_ar TEXT DEFAULT '',
  invoice_subtitle_en TEXT DEFAULT '',
  invoice_subtitle_font_size INTEGER DEFAULT 12,
  statement_title_ar TEXT DEFAULT 'كشف حساب',
  statement_title_en TEXT DEFAULT 'Statement',
  statement_title_font_size INTEGER DEFAULT 18,
  statement_title_visible INTEGER DEFAULT 1,
  statement_title_align TEXT DEFAULT 'center',
  statement_title_bold INTEGER DEFAULT 1,
  statement_subtitle_ar TEXT DEFAULT '',
  statement_subtitle_en TEXT DEFAULT '',
  statement_subtitle_font_size INTEGER DEFAULT 12,
  customer_ledger_title_ar TEXT DEFAULT 'ملخص العميل المالي',
  customer_ledger_title_en TEXT DEFAULT 'Customer Financial Summary',
  customer_ledger_title_font_size INTEGER DEFAULT 18,
  customer_ledger_title_visible INTEGER DEFAULT 1,
  customer_ledger_title_align TEXT DEFAULT 'center',
  customer_ledger_title_bold INTEGER DEFAULT 1,
  customer_ledger_subtitle_ar TEXT DEFAULT '',
  customer_ledger_subtitle_en TEXT DEFAULT '',
  customer_ledger_subtitle_font_size INTEGER DEFAULT 12,
