...
export const companySettingsTableSqlite = sqliteTable("company_settings", {
  ...
  loginMessageText: text("login_message_text").default(""),
  loginMessageType: text("login_message_type").default("welcome"),
  ...
  databaseProvider: text("database_provider").default("sqlite"),
  databaseMode: text("database_mode").default("local"),
  databaseUseConnectionString: integer("database_use_connection_string", { mode: "boolean" }).default(false),
  databaseConnectionString: text("database_connection_string").default(""),
  databaseHost: text("database_host").default(""),
  databasePort: text("database_port").default("5432"),
  databaseName: text("database_name").default(""),
  databaseUsername: text("database_username").default(""),
  databasePassword: text("database_password").default(""),
  syncMode: text("sync_mode").default("local-to-online"),
  syncAutoSync: integer("sync_auto_sync", { mode: "boolean" }).default(false),
  syncTiming: text("sync_timing").default("startup"),
  syncIntervalMinutes: integer("sync_interval_minutes").default(30),
  syncLastSyncTime: text("sync_last_sync_time").default(""),
